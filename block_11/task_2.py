...
for _ in range(quantity):
    ...
    if num > 0:
        print('Число после округления вверх x =', x := ceil(num), ' Натуральный логарифм от числа log(x) =', log(x))
    else:
        print('Число после округления вниз x =', x := floor(num), ' Экспонента в степени числа exp(x) =', exp(x))
